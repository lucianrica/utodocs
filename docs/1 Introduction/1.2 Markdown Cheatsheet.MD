...
## Markdown Cheatsheet
This is intended as a quick reference and showcase. For more complete info, see ![https://daringfireball.net/projects/markdown/](John Gruber's) original spec and the ![https://docs.github.com/en/github/writing-on-github](Github-flavored) Markdown info page.
